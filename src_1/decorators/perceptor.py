...
class perceptor:
    """
    Marking a function with this decorator will wrap the function execution with 
    - measure surprise upon receiving the event 
    - create a short-term-memory with surprise measurement
    """
